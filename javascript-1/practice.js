...
let problem17forEach = myNumbers.forEach((e, index) => myNumbersIndex.push(index))
...
notGeorge.map((e, index) => forTheLoveOfGeorge.push(notGeorge[index] = 'George'))
...
// Code Here
const awesomeArray = [];
const getLevelArray = people.map((e) => awesomeArray.push(e.awesomeLevel))

const totallyAwesome = awesomeArray.reduce((acc, curr) => {return acc + curr}, 0)
